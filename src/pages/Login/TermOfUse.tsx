        ...
        <Column>
            ...
            <Container>
                ...
                <Typo.s4>
                    ...
                    <br />
                    이 약관은 FROM.ANON이 운영하는 FROM.ANON(이하 “몰”이라
                    한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라
                    한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및
                    책임사항을 규정함을 목적으로 합니다.
                    <br /> ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도
                    그 성질에 반하지 않는 한 이 약관을 준용합니다.」
                    <br />
                    <br />
                    <Typo.s1>제2조(정의)</Typo.s1>
                    <br /> ① “몰”이란 OO 회사가 재화 또는 용역(이하 “재화
                    ...
                    <br />
                    <br />
                    <Typo.s1>제3조 (약관 등의 명시와 설명 및 개정)</Typo.s1>
                    <br />
                    ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지
                    주소(소비자의 불만을 처리할 수 있는 곳의 주소를
                    포함),전자우편주소, 개인정보관리책임자등을 이용자가 쉽게 알
                    수 있도록 몰의 초기 서비스화면(전면)에 게시합니다. 다만,
                    ...
                    이상의 사전 유예기간을 두고 공지합니다. 이 경우 "몰“은 개정
                    ...
                    <br />
                    <br /> <Typo.s1>제4조(서비스의 제공 및 변경)</Typo.s1>
                    ...
                    <br />
                    <br />
                    <Typo.s1>제5조(서비스의 중단)</Typo.s1>
                    <br />① “몰”은 컴퓨터 등 정보통신설비의 보수점검․교체 및
                    ...
                    <br /> 1. 가입신청자가 이 약관 제7조제3항에 의하여 이전에
                    ...
                    <br />
                    &nbsp;&nbsp; 5. 재화등의 구매신청 및 이에 관한 확인 또는
                    “몰”의 확인에 대한 동의
                    <br />
                    &nbsp;&nbsp; 6. 결제방법의 선택
                    <br />② “몰”이 제3자에게 구매자 개인정보를 제공할 필요가
                    ...
                    동의절차를 거치지 않아도 됩니다.
                    <br />
                    <br /> <Typo.s1>제10조 (계약의 성립))</Typo.s1>
                    ...
                    수신확인통지를 합니다.
                    <br /> ② 수신확인통지를 받은 이용자는 의사표시의 불일치 등이
                    ...
                    규정에 따릅니다.
                    <br />
                    <br /> <Typo.s1>제13조(재화 등의 공급)</Typo.s1>
                    ...
                    <br /> ④ 이용자는 제1항 및 제2항의 규정에 불구하고 재화 등의
                    ...
                    <br />
                    <br />
                    <Typo.s1>제16조(청약철회 등의 효과)</Typo.s1>
                    <br /> ① “몰”은 이용자로부터 재화 등을 반환받은 경우 3영업일
                    ...
                    <br /> <br />③ 청약철회 등의 경우 공급받은 재화 등의 반환에
                    ...
                    <br />
                    <br />
                    <Typo.s1>제17조(개인정보보호)</Typo.s1>
                    <br /> ① “몰”은 이용자의 개인정보 수집시 서비스제공을 위하여
                    ...
                    <br /> ③ “몰”은 이용자의 개인정보를 수집·이용하는 때에는
                    당해 이용자에게 그 목적을 고지하고 동의를 받습니다.
                    <br /> ④ “몰”은 수집된 개인정보를 목적외의 용도로 이용할 수
                    ...
                    책임을 집니다.
                    <br /> ⑧ “몰” 또는 그로부터 개인정보를 제공받은 제3자는
                    개인정보의 수집목적 또는 제공받은 목적을 달성한 때에는 당해
                    개인정보를 지체 없이 파기합니다.
                    <br /> ⑨ “몰”은 개인정보의 수집·이용·제공에 관한 동의 란을
                    ...
                    <br />
                    <br />
                    <Typo.s1>제19조(회원의 ID 및 비밀번호에 대한 의무)</Typo.s1>
                    ...
                    <br /> 2. 타인의 정보 도용
                    <br /> 3. “몰”에 게시된 정보의 변경
                    <br /> 4. “몰”이 정한 정보 이외의 정보(컴퓨터 프로그램 등)
                    등의 송신 또는 게시
                    <br /> 5. “몰” 기타 제3자의 저작권 등 지적재산권에 대한 침해
                    <br /> 6. “몰” 기타 제3자의 명예를 손상시키거나 업무를
                    방해하는 행위
                    <br /> 7. 외설 또는 폭력적인 메시지, 화상, 음성, 기타
                    공서양속에 반하는 정보를 몰에 공개 또는 게시하는 행위
                    <br />
                    <br />
                    <Typo.s1>제21조(연결“몰”과 피연결“몰” 간의 관계)</Typo.s1>
                    ...
                    않습니다.
                    <br />
                    <br /> <Typo.s1>제22조(저작권의 귀속 및 이용제한)</Typo.s1>
                    ...
                    조정에 따를 수 있습니다.
                    <br />
                    <br /> <Typo.s1>제24조(재판권 및 준거법)</Typo.s1>
